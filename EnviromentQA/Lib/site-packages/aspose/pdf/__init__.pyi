...
class AutoTaggingSettings:
    ...
    The :class:`AutoTaggingSettings` class allows configuring options for automatic tagging of PDF content.
    ...
    default: aspose.pdf.AutoTaggingSettings
    
    @property
    def enable_auto_tagging(self) -> bool:
        '''Gets or sets a value indicating whether the auto-tagging functionality is enabled.
        
        When enabled, the auto-tagging functionality automatically generates tagged content
        for the PDF document, which can improve accessibility and structure.'''
        ...
    
    @enable_auto_tagging.setter
    def enable_auto_tagging(self, value: bool):
        ...
    
    @property
    def heading_recognition_strategy(self) -> aspose.pdf.HeadingRecognitionStrategy:
        '''Gets or sets the strategy used for recognizing headings in the document during auto-tagging.
        
        The :attr:`AutoTaggingSettings.heading_recognition_strategy` property determines how headings are identified
        in the document. Available strategies include recognizing headings based on outlines,
        heuristic analysis, or automatic detection. Setting this property to :attr:`HeadingRecognitionStrategy.NONE`
        disables heading recognition.'''
        ...
    
    @heading_recognition_strategy.setter
    def heading_recognition_strategy(self, value: aspose.pdf.HeadingRecognitionStrategy):
        ...
    
    @property
    def heading_levels(self) -> aspose.pdf.HeadingLevels:
        '''Gets or sets the heading levels used for determining the structure of headings in a PDF document.
        
        The :attr:`AutoTaggingSettings.heading_levels` property allows configuring the mapping of font sizes to heading levels.
    ...
    def heading_levels(self, value: aspose.pdf.HeadingLevels):
        ...
...
class BatesNArtifact(aspose.pdf.PaginationArtifact):
    '''Class describes Bates Numbering artifact.'''
    
    def __init__(self):
        '''Initializes a new instance of the :class:`BatesNArtifact` class.
    ...
    def number_of_digits(self) -> int:
        ...
        The value must be between 3 and 15 inclusive. If a value less than 3 is set, it will be adjusted to 3.
        If a value greater than 15 is set, it will be adjusted to 15.
        The default value is 6.'''
        ...
    
    @number_of_digits.setter
    def number_of_digits(self, value: int):
        ...
...
class BitmapInfo:
    ...
    def __init__(self, pixel_bytes: bytes, width: int, height: int, format):
        '''Creates a new instance of the  class.
        
        :param pixel_bytes: Array of pixels.
...
class ConvertException(aspose.pdf.PdfException):
    '''Represents errors that occur during PDF_A conversion with helpers objects.'''
    
    def __init__(self, message: str):
        '''Initializes a new instance of the :class:`ConvertException` class.
...
class CrashReportOptions:
    ...
    @property
    def crash_report_directory(self) -> str:
        '''Output directory for crash report. By default is set to current directory.'''
        ...
    
    @crash_report_directory.setter
    def crash_report_directory(self, value: str):
        ...
    
    @property
    def crash_report_filename(self) -> str:
        '''Filename for crash report. By default is auto-generated in format CrashReport_date_ticks.html.'''
        ...
    
    @crash_report_filename.setter
    def crash_report_filename(self, value: str):
        ...
...
class Document:
    ...
    @overload
    def __init__(self, input: Any, password: str, is_managed_stream: bool, custom_security_handler: aspose.pdf.security.ICustomSecurityHandler):
        '''Initialize new Document instance from the  stream.
        
        :param input: Stream with pdf document.
        :param password: User or owner password.
        :param is_managed_stream: If set to ``True`` inner stream is closed before exit; otherwise, is not.
        :param custom_security_handler: The custom security handler.'''
        ...
    ...
    @overload
    def __init__(self, input: Any, password: str, custom_security_handler: aspose.pdf.security.ICustomSecurityHandler):
        '''Initialize new Document instance from the  stream.
    ...
    @overload
    def __init__(self, filename: str, password: str, custom_security_handler: aspose.pdf.security.ICustomSecurityHandler):
    ...
    @overload
    def __init__(self, filename: str, password: str, is_managed_stream: bool, custom_security_handler: aspose.pdf.security.ICustomSecurityHandler):
        '''Initializes new instance of the :class:`Document` class for working with encrypted document.
    ...
    @overload
    def __init__(self, version: aspose.pdf.PdfVersion):
    ...
    @overload
    def encrypt(self, user_password: str, owner_password: str, privileges: aspose.pdf.facades.DocumentPrivilege, custom_handler: aspose.pdf.security.ICustomSecurityHandler) -> None:
        ...
        :param custom_handler: The custom security handler.'''
        ...
    
    @overload
    def encrypt(self, user_password: str, owner_password: str, permissions: aspose.pdf.Permissions, custom_handler: aspose.pdf.security.ICustomSecurityHandler) -> None:
        '''Encrypts the document. Call then Save to get encrypted version of the document.
    ...
    def is_repair_needed(self, options) -> bool:
        '''Checks if document requires Repair method call.
        
        :param options: Filled RepairOptions recommended to be used in Repair method
        :returns: Returns filled options to be used in Repair method'''
        ...
    ...
    @property
    def custom_security_handler(self) -> aspose.pdf.security.ICustomSecurityHandler:
...
class FloatingBox(aspose.pdf.BaseParagraph):
    ...
    @property
    def positioning_mode(self) -> aspose.pdf.ParagraphPositioningMode:
        '''Specifies variant for determining the location of the FloatingBox on the page.'''
        ...
    
    @positioning_mode.setter
    def positioning_mode(self, value: aspose.pdf.ParagraphPositioningMode):
        ...
...
class HtmlSaveOptions(aspose.pdf.UnifiedSaveOptions):
    ...
    class RasterImagesSavingModes:
          ...
          DONT_SAVE: RasterImagesSavingModes
...
class Image(aspose.pdf.BaseParagraph):
    ...
    @property
    def bitmap_info(self) -> aspose.pdf.BitmapInfo:
        '''Gets or sets uncompressed image bytes.'''
        ...
    
    @bitmap_info.setter
    def bitmap_info(self, value: aspose.pdf.BitmapInfo):
        ...
...
class Layer:
    ...
    def save(self, output_stream: Any) -> None:
        ...
        :param output_stream: The stream where the PDF document will be saved.'''
        ...
...
class MarkdownSaveOptions(aspose.pdf.UnifiedSaveOptions):
    ...
    @property
    def line_break_style(self) -> aspose.pdf.LineBreakStyle:
        '''Gets or sets the line break style for generated document.'''
        ...
    
    @line_break_style.setter
    def line_break_style(self, value: aspose.pdf.LineBreakStyle):
        ...
    
    @property
    def emphasis_style(self) -> aspose.pdf.EmphasisStyle:
        '''Gets or sets the style of emphasis for generated document.'''
        ...
    
    @emphasis_style.setter
    def emphasis_style(self, value: aspose.pdf.EmphasisStyle):
        ...
    
    @property
    def heading_style(self) -> aspose.pdf.HeadingStyle:
        '''Gets or sets the heading style for generated document.'''
        ...
    
    @heading_style.setter
    def heading_style(self, value: aspose.pdf.HeadingStyle):
        ...
    
    @property
    def heading_levels(self) -> aspose.pdf.HeadingLevels:
        '''Defines expected heading levels to use in FontSize recognition headers strategy.
        If this property value is set, then header recognition :attr:`HeadingRecognitionStrategy.HEURISTIC` strategy will be selected when set PdfToMarkdown.HeadingRecognitionStrategy.Auto strategies even if the document contains bookmarks.'''
        ...
...
class Matrix:
    ...
    def get_flip_matrix(self) -> aspose.pdf.Matrix:
...
class ObjectReferenceCorruptedException(aspose.pdf.PdfException):
...
class OutputIntent:
    ...
    def __init__(self, output_condition_identifier: str):
        '''Initializes a new instance of the :class:`OutputIntent` class with the specified output condition identifier.
        
        :param output_condition_identifier: The text that identifies the intended output device or production condition in human- or machine-readable form.'''
        ...
...
class Page:
    ...
    @overload
    def add_image(self, image_stream: Any, image_rect: aspose.pdf.Rectangle, bbox: aspose.pdf.Rectangle, auto_adjust_rectangle: bool) -> None:
        ...
        :param bbox: Bbox of the image.
        :param auto_adjust_rectangle: Adjust image in center of the input rectangle.'''
        ...

    @overload
    def add_image(self, image_stream: Any, image_rect: aspose.pdf.Rectangle, bbox: aspose.pdf.Rectangle) -> None:
        '''Adds image onto the page and locates it in the middle of specified rectangle saving image's proportion.
    ...
    @overload
    def add_image(self, hocr: str, image_stream: Any, image_rect: aspose.pdf.Rectangle, bbox: aspose.pdf.Rectangle) -> None:
    ...
    @overload
    def add_image(self, image_stream: Any, image_rect: aspose.pdf.Rectangle, image_width: int, image_height: int, save_image_proportions: bool, bbox: aspose.pdf.Rectangle) -> None:
    ...
    def get_resources(self) -> aspose.pdf.Resources:
        ...
        :returns: A :attr:`Page.resources` object representing the resources of the page.'''
        ...
...
class PageCollectionExtensions:
    ...
    @staticmethod
    def update_pagination(self, page_collection: aspose.pdf.PageCollection) -> None:
        ...
        :param page_collection: The page collection.'''
        ...
    
    @staticmethod
    def add_pagination(self, page_collection: aspose.pdf.PageCollection, artifacts) -> None:
        ...
    
    @staticmethod
    def add_bates_numbering(self, page_collection: aspose.pdf.PageCollection, artifact: aspose.pdf.BatesNArtifact) -> None:
        '''Adds the specified Bates numbering artifact to each page in the given page collection.
        
        :param page_collection: The collection of pages to which the Bates numbering artifact will be added.
        :param artifact: The BatesNArtifact instance to be added to each page.'''
        ...
    
    @staticmethod
    def delete_bates_numbering(self, page_collection: aspose.pdf.PageCollection) -> None:
        '''Deletes all Bates numbering artifacts from each page in the given page collection.
        
        :param page_collection: The collection of pages from which the Bates numbering will be deleted.'''
        ...
...
class PaginationArtifact(aspose.pdf.Artifact):
    ...
    def end_page(self) -> int:
        ...
        The value must be greater than or equal to 0. If a value less than 0 is set, it will be adjusted to 0.
        The default value of 0 means there are no end page boundaries.'''
        ...
...
class PdfException(RuntimeError):
    ...
    @staticmethod
    def generate_crash_report(self, options: aspose.pdf.CrashReportOptions) -> None:
        '''Forms crash report based on Exception HTML format
        
        :param options: Set of attributes to customize data included into crash report'''
        ...
...
class PdfFormatConversionOptions:
    ...
    @property
    def output_intent(self) -> aspose.pdf.OutputIntent:
        '''Gets or sets the :class:`OutputIntent` for the PDF format conversion.
        
        The :attr:`PdfFormatConversionOptions.output_intent` specifies the intended output device or condition
    ...
    def output_intent(self, value: aspose.pdf.OutputIntent):
        ...
    ...
    @property
    def auto_tagging_settings(self) -> aspose.pdf.AutoTaggingSettings:
        '''Gets or sets the settings for automatic tagging during PDF format conversion.
        
        Automatic tagging settings are used to configure the behavior of the auto-tagging process,
        which is typically employed to enhance the accessibility and structure of a PDF document
        during conversion to a specific PDF format.'''
        ...
    
    @auto_tagging_settings.setter
    def auto_tagging_settings(self, value: aspose.pdf.AutoTaggingSettings):
        ...
...
class Rectangle:
    ...
    def contains(self, point: aspose.pdf.Point, inclusive: bool) -> bool:
        '''Determinces whether given point is inside of the rectangle.
        
        :param point: Point to check.
        :param inclusive: inclusive: point may be on edge
        :returns: True if point is inside of the rectangle.'''
        ...
    ...
    def move_by(self, dx: float, dy: float) -> None:
        ...
        :param dx: Value of shift by X axis.
        :param dy: Value of shift by Y axis.'''
        ...
...
class RegexManager:
    ...
    match_timeout: datetime.timespan
...
class RenderingOptions:
    ...
    @analyze_fonts.setter
    def analyze_fonts(self, value: bool):
        ...
...
class SignaturesCompromiseDetector:
    ...
    The detector checks only known ways to compromise signatures.
    Verification cannot provide a 100% guarantee of the absence of signature compromise and may yield a false negative result for new,
    unknown compromise methods different from those being tested.'''
    
    def __init__(self, document: aspose.pdf.Document):
        '''Creates an instance of :class:`SignaturesCompromiseDetector` class.
        
        :param document:'''
        ...
    
    def check(self, compromise_check_result) -> bool:
        '''Check the digital signatures of the document for compromise.
        
        :param compromise_check_result: The result of verification of the document.
        :returns: True, if the compromise of the signatures is not detected.
...
class TextStamp(aspose.pdf.Stamp):
    ...
    @property
    def auto_adjust_font_size_to_fit_stamp_rectangle(self) -> bool:
        '''If enabled, the font size will be automatically adjusted to fit the stamp rectangle of size: :attr:`TextStamp.width` and :attr:`TextStamp.height`. Default width and height are derived from the page rectangle.'''
        ...
    
    @auto_adjust_font_size_to_fit_stamp_rectangle.setter
    def auto_adjust_font_size_to_fit_stamp_rectangle(self, value: bool):
        ...
    
    @property
    def auto_adjust_font_size_precision(self) -> float:
        '''Automatically adjust font size precision. Default value: 0.1;'''
        ...
    
    @auto_adjust_font_size_precision.setter
    def auto_adjust_font_size_precision(self, value: float):
        ...
...
class XImageCollection:
    ...
    @overload
    def add(self, bitmap_info: aspose.pdf.BitmapInfo) -> str:
        '''Adds entity to the end of the collection, so entity can be accessed by the last index.
        
        :param bitmap_info: Object containing array of pixels and bitmap information (Width, Height, PixelFormat).
        :returns: Name of the added image.'''
        ...
    ...
    @overload
    def add(self, bitmap_info: aspose.pdf.BitmapInfo, filter_type: aspose.pdf.ImageFilterType) -> str:
        '''Adds entity to the end of the collection, so entity can be accessed by the last index.
...
class XpsSaveOptions(aspose.pdf.UnifiedSaveOptions):
    ...
    @property
    def use_embedded_true_type_fonts(self) -> bool:
        '''Gets/sets the flag to use embedded TrueType fonts.
        Avoiding the use of embedded TrueType fonts can reduce conversion time.'''
        ...
    
    @use_embedded_true_type_fonts.setter
    def use_embedded_true_type_fonts(self, value: bool):
        ...
...
class ParagraphPositioningMode:
    '''Specifies variant for determining the location of the element on the page.'''
    
    DEFAULT: ParagraphPositioningMode
    ABSOLUTE: ParagraphPositioningMode
