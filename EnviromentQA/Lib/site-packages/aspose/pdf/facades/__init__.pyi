...
class PdfConverter(aspose.pdf.facades.Facade):
    ...
    @overload
    def bind_pdf(self, src_doc: aspose.pdf.Document) -> None:
        '''Binds a PDF document to the :class:`PdfConverter` instance for further processing.
        
        :param src_doc: The :class:`aspose.pdf.Document` object representing the source PDF to be bound.
        
        This method initializes the :class:`PdfConverter` with the specified PDF document.
...
class PdfFileInfo(aspose.pdf.facades.SaveableFacade):
    ...
    @overload
    def __init__(self, input_stream: Any, password: str, custom_security_handler: aspose.pdf.security.ICustomSecurityHandler):
        '''Initializes a new instance of the Aspose.Pdf.Facades.PdfFileInfo class.
    ...
    @overload
    def __init__(self, input_file: str, password: str, custom_security_handler: aspose.pdf.security.ICustomSecurityHandler):
        '''Initializes a new instance of the Aspose.Pdf.Facades.PdfFileInfo class.
...
class PdfFileSignature(aspose.pdf.facades.SaveableFacade):
    ...
    @overload
    def covers_whole_document(self, sign_name: aspose.pdf.facades.SignatureName) -> bool:
        '''Checks if the signature covers the whole document.
    ...
    @overload
    def get_revision(self, sign_name: aspose.pdf.facades.SignatureName) -> int:
        '''Gets the revision of a signature.
    ...
    @overload
    def remove_signature(self, sign_name: aspose.pdf.facades.SignatureName) -> None:
        '''Remove the signature according to the name of the signature.
    ...
    @overload
    def remove_signature(self, sign_name: aspose.pdf.facades.SignatureName, remove_field: bool) -> None:
        '''Removes the signature according to the name of the signature.
    ...
    @overload
    def get_signer_name(self, sign_name: aspose.pdf.facades.SignatureName) -> str:
        '''Gets the name of person or organization who signing the pdf document.
    ...
    @overload
    def get_date_time(self, sign_name: aspose.pdf.facades.SignatureName) -> datetime.datetime:
        '''Gets the signature's datetime.
    ...
    @overload
    def get_reason(self, sign_name: aspose.pdf.facades.SignatureName) -> str:
        '''Gets the reason of a signature.
    ...
    @overload
    def get_location(self, sign_name: aspose.pdf.facades.SignatureName) -> str:
        '''Gets the location of a signature.
    ...
    @overload
    def get_contact_info(self, sign_name: aspose.pdf.facades.SignatureName) -> str:
        '''Gets the contact information of a signature.
    ...
    @overload
    def verify_signature(self, sign_name: aspose.pdf.facades.SignatureName) -> bool:
        '''Checks the validity of a signature.
    ...
    @overload
    def verify_signature(self, sign_name: str, options: aspose.pdf.security.ValidationOptions, validation_result) -> bool:
        '''Checks the validity of a signature.
        
        :param sign_name: The name of signature.
        :param options: The verification options.
        :param validation_result: The certificate validation result.
        :returns: Return a result of bool type.
    ...
    @overload
    def verify_signature(self, sign_name: aspose.pdf.facades.SignatureName, options: aspose.pdf.security.ValidationOptions, validation_result) -> bool:
        '''Checks the validity of a signature.
    ...
    @overload
    def verify_signature(self, sign_name: aspose.pdf.facades.SignatureName, public_key_certificate, options: aspose.pdf.security.ValidationOptions, validation_result) -> bool:
        '''Checks the validity of a signature.
        Verification is performed using the external public key certificate.
        
        :param sign_name: The name of signature.
        :param public_key_certificate: The public key certificate for verification.
        :param options: The verification options.
        :param validation_result: The certificate validation result.
        :returns: Return a result of bool type.
    ...
    @overload
    def verify_signature(self, sign_name: aspose.pdf.facades.SignatureName, public_key_certificate) -> bool:
        '''Checks the validity of a signature.
        Verification is performed using the external public key certificate.
    ...
    @overload
    def extract_image(self, sign_name: aspose.pdf.facades.SignatureName) -> Any:
        '''Extracts signature's image.
    ...
    @overload
    def extract_certificate(self, sign_name: aspose.pdf.facades.SignatureName) -> Any:
        '''Extracts signature's single X.509 certificate as a stream.
    ...
    @overload
    def try_extract_certificate(self, sign_name: aspose.pdf.facades.SignatureName, certificate) -> bool:
        '''Extracts signature's single X.509 certificate.
        
        :param sign_name: The name of signature.
        :param certificate: If a certificate was found returns X.509 single certificate object; otherwise, null.
        :returns: True certificate was found.'''
        ...
    
    @overload
    def try_extract_certificate(self, sign_name: aspose.pdf.facades.SignatureName, stream) -> bool:
        '''Extracts signature's single X.509 certificate as a stream.
        
        :param sign_name: The name of signature.
        :param stream: If a certificate was found returns X.509 single certificate stream; otherwise, null.
        :returns: True certificate was found.'''
        ...
    ...
    def get_signature_names(self, only_active: bool) -> list[aspose.pdf.facades.SignatureName]:
        '''Gets the names of all not empty signatures.
        
        :param only_active: if true, return only active signatures; otherwise, return all signatures.
        :returns: Return an IList\<SignatureName\>.'''
        ...
    ...
    def get_signatures_info(self) -> None:
        '''Retrieves information about all signatures algorithm present in the PDF document.
        
        :returns: A list of :class:`aspose.pdf.security.SignatureAlgorithmInfo` instances containing information about each signature.'''
        ...
...
class PdfViewer:
    ...
    @overload
    @staticmethod
    def print_documents(self, documents: list[aspose.pdf.Document]) -> None:
        ...
    
    @overload
    @staticmethod
    def print_documents(self, file_paths: list[str]) -> None:
        ...
    
    @overload
    @staticmethod
    def print_documents(self, document_streams: list[Any]) -> None:
        ...
    
    @overload
    @staticmethod
    def print_documents(self, printer_settings: aspose.pdf.printing.PrinterSettings, documents: list[aspose.pdf.Document]) -> None:
        ...
    
    @overload
    @staticmethod
    def print_documents(self, printer_settings: aspose.pdf.printing.PrinterSettings, file_paths: list[str]) -> None:
        ...
    
    @overload
    @staticmethod
    def print_documents(self, printer_settings: aspose.pdf.printing.PrinterSettings, document_streams: list[Any]) -> None:
        ...
    
    @overload
    @staticmethod
    def print_documents(self, printer_settings: aspose.pdf.printing.PrinterSettings, page_settings: aspose.pdf.printing.PageSettings, documents: list[aspose.pdf.Document]) -> None:
        ...
    
    @overload
    @staticmethod
    def print_documents(self, printer_settings: aspose.pdf.printing.PrinterSettings, page_settings: aspose.pdf.printing.PageSettings, file_paths: list[str]) -> None:
        ...
    
    @overload
    @staticmethod
    def print_documents(self, printer_settings: aspose.pdf.printing.PrinterSettings, page_settings: aspose.pdf.printing.PageSettings, document_streams: list[Any]) -> None:
        ...
