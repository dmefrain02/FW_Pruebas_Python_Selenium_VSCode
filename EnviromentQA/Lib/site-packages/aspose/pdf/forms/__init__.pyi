...
class ExternalSignature(aspose.pdf.forms.Signature):
    ...
    @overload
    def __init__(self, certificate, digest_hash_algorithm: aspose.pdf.DigestHashAlgorithm):
        ...
        :param certificate: The certificate with the private key.
        :param digest_hash_algorithm: The digest algorithm to sign a document.'''
        ...

    @overload
    def __init__(self, certificate, detached: bool):
        '''Creates a detached PKCS#7Detached signature using a X509Certificate2. It supports usb smartcards, tokens without exportable private keys.
        
        :param certificate: The certificate with the private key.
        :param detached: True if the signature should be detached, otherwise false.'''
        ...
    ...
    @overload
    def __init__(self, base64: str, digest_hash_algorithm: aspose.pdf.DigestHashAlgorithm):
        '''Creates a PKCS#7 (detached) signature using a X509Certificate2 as base64 string.
...
class Form:
    ...
    def make_form_annotations_independent(self, page: aspose.pdf.Page) -> None:
    ...
    def needs_rendering(self) -> bool:
        ...
        This property was introduced to determine if :attr:`Form.ignore_needs_rendering` should be used
        to remove the XFA form in cases where the XFA form is present and :attr:`Form.needs_rendering` is false.'''
        ...
...
class PKCS7Detached(aspose.pdf.forms.Signature):
    ...
    @overload
    def __init__(self, image: Any, digest_hash_algorithm: aspose.pdf.DigestHashAlgorithm):
        '''Initializes new instance of the :class:`PKCS7Detached` class.
    ...
    @overload
    def __init__(self, digest_hash_algorithm: aspose.pdf.DigestHashAlgorithm):
        '''Inititalizes new instance of the :class:`PKCS7Detached` class.
    ...
    @overload
    def __init__(self, pfx: str, password: str, digest_hash_algorithm: aspose.pdf.DigestHashAlgorithm):
        '''Inititalizes new instance of the :class:`PKCS7Detached` class.
    ...
    @overload
    def __init__(self, pfx: Any, password: str, digest_hash_algorithm: aspose.pdf.DigestHashAlgorithm):
        '''Inititalizes new instance of the :class:`PKCS7Detached` class.
...
class Signature:
    ...
    @overload
    def verify(self, options: aspose.pdf.security.ValidationOptions, validation_result) -> bool:
        '''Verify the document regarding this signature and return true if document is valid
        or otherwise false.
    ...
    @overload
    def verify(self, public_key_certificate, options: aspose.pdf.security.ValidationOptions, validation_result) -> bool:
        '''Verify the document regarding this signature and return true if document is valid
        or otherwise false.
    ...
    def get_signature_algorithm_info(self) -> aspose.pdf.security.SignatureAlgorithmInfo:
        '''Retrieves information about the signature algorithm used in the signature.
        
        :returns: An instance of :class:`aspose.pdf.security.SignatureAlgorithmInfo` that contains details
    ...
    @property
    def avoid_estimating_signature_length(self) -> bool:
        ...
        Used for signing via Aspose.Pdf.Forms.Signature.CustomSignHash an via :class:`ExternalSignature`.
        If Aspose.Pdf.Forms.Signature.CustomSignHash returns a signature longer than :attr:`Signature.default_signature_length`, then :class:`aspose.pdf.security.SignatureLengthMismatchException` will be thrown.
        The default value is false.'''
        ...
    
    @avoid_estimating_signature_length.setter
    def avoid_estimating_signature_length(self, value: bool):
        ...
    
    @property
    def default_signature_length(self) -> int:
        ...
        Used for signing via Aspose.Pdf.Forms.Signature.CustomSignHash if the :attr:`Signature.avoid_estimating_signature_length` parameter is set.
        The default value is 3000.'''
        ...
    
    @default_signature_length.setter
    def default_signature_length(self, value: int):
        ...
...
class SignatureField(aspose.pdf.forms.Field):
    ...
    def extract_certificate_object(self) -> None:
...
class TextBoxField(aspose.pdf.forms.Field):
    ...
    @overload
    def __init__(self, page: aspose.pdf.Page, rects: list[aspose.pdf.Rectangle]):
        '''Constructor of TextBox field.
        
        :param page: Page where text field is placed.
        :param rects: Rectangles defining the placement of TextBoxField widget annotations on the page.'''
        ...
