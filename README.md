...
| `/src/Pages`                       | Objetos de página (Page Objects) con las acciones de las Pages y de donde se leen los elementosen la paginas através de archivos JSON que contienen los localizadores  de los  elementos (en proceso de refactorización).                                                                                                           | 
